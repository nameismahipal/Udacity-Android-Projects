...
public class BaseConfig {
    ...
    private final static  String PORTRAIT_BACKDROP_POSTER_SIZE  = "/w342";

    private final static  String LANDSCP_POSTER_SIZE           = "/w185";
    private final static  String LANSCP_BACKDROP_POSTER_SIZE  = "/w500";
    ...
    public final static String POSTER_IMAGE_URL_PATH     = IMAGE_BASE_URL + PORTRAIT_POSTER_SIZE;
